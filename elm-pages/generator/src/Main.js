...
{
	if (region.T.t === region.ag.t)
	{
		return 'on line ' + region.T.t;
	}
	return 'on lines ' + region.T.t + ' through ' + region.ag.t;
}
...
var $author$project$Main$Build = {$: 1};
var $author$project$Main$Develop = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$DevelopOptions = F2(
	function (_debugger, customPort) {
		return {y: customPort, ae: _debugger};
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$add = F2(
	function (optionsParser, _v0) {
		...
		var optionsParsers = programRecord.F;
...
var $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand = F2(
	function (subCommandName, cliOptionsConstructor) {
		return {
			...
			p: $elm$core$Maybe$Just(subCommandName),
			X: _List_Nil
		};
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$config = {F: _List_Nil};
...
var $dillonkearns$elm_cli_options_parser$Cli$Option$buildOption = F2(
	function (dataGrabber, usageSpec) {
		return {r: dataGrabber, n: $dillonkearns$elm_cli_options_parser$Cli$Decode$decoder, m: usageSpec};
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$updateDecoder = F2(
	function (decoder, _v0) {
		...
		return {n: decoder, q: optionsParserRecord.q, p: optionsParserRecord.p, X: optionsParserRecord.X};
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$Option$updateDecoder = F2(
	function (mappedDecoder, _v0) {
		var option = _v0;
		var dataGrabber = option.r;
		var usageSpec = option.m;
						...
						if (!_v0.$) {
							...
							return $elm$core$Result$Err(
								$dillonkearns$elm_cli_options_parser$Cli$Decode$UnrecoverableValidationError(
									{
										a_: invalidReason,
										a4: $dillonkearns$elm_cli_options_parser$Cli$UsageSpec$name(optionRecord.m)
									}));
						}
					},
					decoder);
...
var $dillonkearns$elm_cli_options_parser$Cli$Option$validateMapIfPresent = F2(
	function (mapFn, cliSpec) {
		var dataGrabber = cliSpec.r;
		var usageSpec = cliSpec.m;
...
var $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withCommon = F2(
	function (_v0, fullOptionsParser) {
		...
		var decoder = optionsParser.n;
		var usageSpecs = optionsParser.X;
		return function (_v4) {
			var record = _v4;
			return _Utils_update(
				record,
				...
				function (optionsAndOperands) {
					return A2(
						...
						A2(
							...
							innerOption.r(
								{
									u: optionsAndOperands.u,
									be: $dillonkearns$elm_cli_options_parser$Cli$UsageSpec$operandCount(usageSpecs),
									E: optionsAndOperands.E,
									X: optionsAndOperands.X
								})));
				},
				fullOptionsParser));
	});
...
var $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withDoc = F2(
	function (docString, _v0) {
		...
		return _Utils_update(
			optionsParserRecord,
			{
				q: $elm$core$Maybe$Just(docString)
			});
	});
var $author$project$Main$application = A2(
	$dillonkearns$elm_cli_options_parser$Cli$Program$add,
	A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'build', $author$project$Main$Build),
	A2(
		$dillonkearns$elm_cli_options_parser$Cli$Program$add,
		A2(
			$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$map,
			$author$project$Main$Develop,
			A2(
				...
				A2(
					...
					A2(
						...
						$elm$core$Result$fromMaybe('port needs to be an integer')),
					$dillonkearns$elm_cli_options_parser$Cli$Option$optionalKeywordArg('port')),
				A2(
					$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$with,
					$dillonkearns$elm_cli_options_parser$Cli$Option$flag('debug'),
					A2(
						$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withDoc,
						'you can set the port with --port=3200',
						A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'develop', $author$project$Main$DevelopOptions))))),
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'debug',
					$elm$json$Json$Encode$bool($.ad)),
					_Utils_Tuple2(
					'watch',
					$elm$json$Json$Encode$bool($.aJ))
				]));
	});
var $author$project$Main$init = F2(
	function (flags, cliOptions) {
		var _v0 = function () {
			if (!cliOptions.$) {
				var options = cliOptions.a;
				return _Utils_Tuple3(true, options.ae, options.y);
			} else {
				return _Utils_Tuple3(false, false, $elm$core$Maybe$Nothing);
			}
		}();
		var watch = _v0.a;
		var debug = _v0.b;
		var customPort = _v0.c;
		return $author$project$Main$writeFile(
			{y: customPort, ad: debug, aJ: watch});
	});
...
var $dillonkearns$elm_cli_options_parser$Fuzzy$distance = F3(
	function (config, needle, hay) {
		...
		var hPenalty = ($elm$core$String$length(hay) - $elm$core$List$length(accumulated)) * config.x;
		var nPenalty = ($elm$core$String$length(needle) - $elm$core$List$length(accumulated)) * config.I;
		...
		var iPenalty = A3(
			...
			sorted.b).b * config.A;
		var mPenalty = sorted.a * config.D;
		return A4(
	...
	function (configs, separators, needle, hay) {
		...
		var minScore = F2(
			function (n, _v2) {
				var offset = _v2.a;
				var hs = _v2.b;
				var initialPenalty = ((($elm$core$String$length(n) * config.I) + ($elm$core$String$length(n) * config.D)) + ($elm$core$String$length(hay) * config.x)) + (($elm$core$String$length(hay) * $elm$core$String$length(n)) * config.A);
				...
				var accumulateMatch = F2(
					function (e, _v1) {
						...
						var newMatch = (_Utils_cmp(eDistance.o, prev.o) < 0) ? _Utils_update(
							eDistance,
							{av: prevOffset}) : prev;
...
var $dillonkearns$elm_cli_options_parser$TypoSuggestion$getSuggestions = F2(
	function (optionsParsers, unexpectedOption) {
		var something = F2(
			function (needle, hay) {
				return A4($dillonkearns$elm_cli_options_parser$Fuzzy$match, _List_Nil, _List_Nil, needle, hay).o;
			});
		return A2(
	...
	return _Utils_update(
		optionsParser,
		{
			n: function (flagsAndOperands) {
				var unexpectedOptions = A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$unexpectedOptions_, fullOptionsParser, flagsAndOperands.E);
		...
		if (_v2.b) {
			if (!_v2.b.b) {
				...
				return $dillonkearns$elm_cli_options_parser$Tokenizer$EqualsSplitter$KeywordArg(
					{
						a4: firstOptionName,
						bm: $elm$core$String$concat(splitAfterOptionName)
					});
			}
		} else {
...
var $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$tryMatch = F2(
	function (argv, optionsParser) {
		var usageSpecs = optionsParser.X;
		var subCommand = optionsParser.p;
		var flagsAndOperands = function (record) {
			var _v5 = _Utils_Tuple2(subCommand, record.u);
			if (_v5.a.$ === 1) {
				var _v6 = _v5.a;
				return $elm$core$Result$Ok(
					{u: record.u, E: record.E, X: usageSpecs});
			} else {
				if (_v5.b.b) {
					...
					return _Utils_eq(actualSubCommand, buildSubCommandName) ? $elm$core$Result$Ok(
						{u: remainingOperands, E: record.E, X: usageSpecs}) : $elm$core$Result$Err(
						{O: 'Sub optionsParser does not match', E: record.E});
				} else {
					var buildSubCommandName = _v5.a.a;
					return $elm$core$Result$Err(
						{O: 'No sub optionsParser provided', E: record.E});
				}
			}
		}(
		...
		if (!flagsAndOperands.$) {
			...
			var errorMessage = flagsAndOperands.a.O;
			var options = flagsAndOperands.a.E;
							...
							$dillonkearns$elm_cli_options_parser$TypoSuggestion$toMessage(
								A2(
									...
									function (optionsParser) {
										return {
											p: $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$getSubCommand(optionsParser),
											X: $dillonkearns$elm_cli_options_parser$Cli$OptionsParser$getUsageSpecs(optionsParser)
										};
									},
									optionsParsers)),
							unexpectedOptions)));
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$init = F2(
	function (options, flags) {
		var matchResult = A3($dillonkearns$elm_cli_options_parser$Cli$Program$run, options.aR, flags.aN, flags.bn);
		var cmd = function () {
			if (!matchResult.$) {
				var exitStatus = matchResult.a;
				var message = matchResult.b;
				if (exitStatus === 1) {
					return options.bg(message);
				} else {
					return options.bh(message);
				}
			} else {
				var msg = matchResult.a;
				return A2(options.aY, flags, msg);
			}
		}();
...
var $dillonkearns$elm_cli_options_parser$Cli$Program$stateless = function (options) {
	return $elm$core$Platform$worker(
		{
			aY: $dillonkearns$elm_cli_options_parser$Cli$Program$init(options),
			K: function (_v0) {
...
var $author$project$Main$main = $dillonkearns$elm_cli_options_parser$Cli$Program$stateless(
	{aR: $author$project$Main$application, aY: $author$project$Main$init, bg: $author$project$Main$printAndExitFailure, bh: $author$project$Main$printAndExitSuccess});
